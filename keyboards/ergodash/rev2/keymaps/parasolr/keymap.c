...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * |Ctr+Al|   A  |   S  |   D  |   F  |   G  |   [  |                    |   ]  |   H  |   J  |   K  |   L  |   ;  |  "   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * | Shift|   Z  |   X  |   C  |   V  |   B  | Ctrl |                    |  Alt |   N  |   M  |   ,  |   .  |   /  |  Up  |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      |Ctr+Sf|  GUI |||||||| Shift| Lower|Sft+Sp|||||||| Enter| Raise| Bksp ||||||||  GUI | Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_GRV,                         KC_EQL,  KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,  \
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_MINS,                        KC_QUOT, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSLS, \
    LCTL(KC_LALT), KC_A, KC_S, KC_D,    KC_F,    KC_G,    KC_LBRC,                        KC_RBRC, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LCTL,                        KC_RALT, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_UP,   \
    _______, _______, LCTL(KC_LSFT), KC_LGUI,    KC_LSFT, LOWER,   LSFT(KC_SPC),  KC_ENT, RAISE,   KC_BSPC,          KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
   ...
   * |  Tab |   !  |   @  |   #  |   $  |   %  |   ~  |                    |   +  |   ^  |   &  |   *  |   (  |   )  |  |   |
   * |------+------+------+------+------+------+------+--------------------+------+------+------+------+------+------+------|
   * |Ctr+Al|   1  |   2  |   3  |   4  |   5  | EISU |                    | KANA |   6  |   7  |   8  |   9  |   0  |  "   |
   * |------+------+------+------+------+------+---------------------------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      | Ctrl |                    |  Alt |   /  |      |   <  |   >  |   ?  |  Up  |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      |Ctr+Sf|  GUI |||||||| Shift| Lower| Space|||||||| Enter| Raise| BkSp ||||||||  GUI |  Left| Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_LOWER] = LAYOUT(
    ...
    LCTL(KC_LALT), KC_1, KC_2, KC_3,    KC_4,    KC_5,    KC_LANG2,                       KC_LANG1, KC_6,   KC_7,    KC_8,    KC_9,    KC_0,    KC_DQUO, \
    _______, _______, _______, _______, _______, _______, KC_LCTL,                        KC_RALT, KC_SLSH, _______, KC_LT,   KC_GT,   KC_QUES, KC_UP,   \
    _______, _______, LCTL(KC_LSFT), KC_LGUI,    KC_LSFT, LOWER,   KC_SPC,        KC_ENT, RAISE, KC_BSPC,          KC_RGUI,   KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      |      |  GUI |||||||| Shift| Lower| Space|||||||| Enter| Raise| BkSp ||||||||  GUI |  Left| Right| Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_RAISE] = LAYOUT(
    ...
    _______, _______, _______, KC_LGUI,          KC_LSFT, LOWER,   KC_SPC,        KC_ENT, RAISE,   KC_BSPC,          KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
