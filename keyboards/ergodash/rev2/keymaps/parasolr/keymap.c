...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      | Ctrl |  GUI |||||||| Shift| Lower|Sft+Sp|||||||| Enter| Raise| Bksp ||||||||  GUI | Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    _______, _______, KC_LCTL, KC_LGUI,          KC_LSFT, LOWER,   LSFT(KC_SPC),  KC_ENT, RAISE,   KC_BSPC,          KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
   ...
   * |      |      |      |      |      |      | Ctrl |                    |  Alt |   /  |      |   <  |   >  |   ?  |  Up  |
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      |  Ctrl|  GUI |||||||| Shift| Lower| Space|||||||| Enter| Raise| BkSp ||||||||  GUI |  Left| Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_LOWER] = LAYOUT(
    ...
    _______, _______, KC_LCTL, KC_LGUI,          KC_LSFT, LOWER,   KC_SPC,        KC_ENT, RAISE, KC_BSPC,          KC_RGUI,   KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      |  Ctrl|  GUI |||||||| Shift| Lower| Space|||||||| Enter| Raise| BkSp ||||||||  GUI |  Left| Right| Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_RAISE] = LAYOUT(
