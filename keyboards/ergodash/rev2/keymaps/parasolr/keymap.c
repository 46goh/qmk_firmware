...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-------------+------+------+------+------+------+------+------+------+------+------+------+------+------+-------------|
   * |      |      | Ctrl |  GUI |||||||| Lower| Shift|Sft+Sp|||||||| Enter| BkSp | Raise||||||||  GUI | Left | Down | Right|
   * ,----------------------------------------------------------------------------------------------------------------------.
   */
  [_QWERTY] = LAYOUT( \
    ...
    _______, _______, KC_LCTL, KC_LGUI,          LOWER,   KC_LSFT,  LSFT(KC_SPC), KC_ENT, KC_BSPC, RAISE,            KC_RGUI, KC_LEFT, KC_DOWN, KC_RGHT  \
  ),
